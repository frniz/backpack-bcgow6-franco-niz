...
func TestUpdateService(t *testing.T) {
	...
	esperado := Transaction{
		...
		Price:    2.0,
		Emitter:  "After emitter",
		Receiver: "After receiver",
		Date:     "After date",
	}

	resultado1, err1 := service.Update(esperado.ID, esperado.Code, esperado.Currency, esperado.Price,
		esperado.Emitter, esperado.Receiver, esperado.Date)
	resultado2, err2 := service.GetAll()
